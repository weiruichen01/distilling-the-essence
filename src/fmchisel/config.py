...
class TrainingArgs:
    ...
    enable_fsdp2: bool = field(default=False)
...
class DataLoadingConfig:
    ...
    # Additional data configuration options for reasoning LLMs
    response_template: str = field(default="", metadata={"help": "Response template for data collator"})
    random_mask_ratio: float = field(default=0.0, metadata={"help": "Random mask ratio for data collator"})
    section_inclusion: str = field(default="promptcotAns", metadata={"help": "Section inclusion strategy (e.g., 'promptcotAns')"})
    included_first_x_percent: float = field(default=1.0, metadata={"help": "Percentage of first tokens to include"})
    half_keep_strategy: str = field(default=None, metadata={"help": "Strategy for keeping half tokens (left/middle/right)"})
    is_reasoning_llm: bool = field(default=True, metadata={"help": "Whether the model is a reasoning LLM"})
    cot_start_token: str = field(default="<think>", metadata={"help": "Chain-of-thought start token"})
    cot_end_token: str = field(default="</think>", metadata={"help": "Chain-of-thought end token"})
    truncate_after_think_end_token: bool = field(default=False, metadata={"help": "Whether to truncate after CoT end token"})
